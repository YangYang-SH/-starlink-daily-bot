...
def generate_report(news_text):
    ...
    prompt = f"""
请扮演一位专业的科技新闻分析师。先自行收集Starlink当天最新的信息，重点关注FCC关于Starlink或者SpaceX的申请/征询/批准的信息，然后结合以下关于 Starlink (星链) 的最新新闻资讯，用中文写一份日报。
...
def send_email(content):
    ...
    <body>
        ...
        <div class="footer">
            Generated by Gemini 3 Flash Preview | 自动发送邮件系统
        </div>
    </body>
    </html>
    """
